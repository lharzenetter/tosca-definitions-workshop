...
LOCK TABLES `mtt_lists` WRITE;
/*!40000 ALTER TABLE `mtt_lists` DISABLE KEYS */;
INSERT INTO `mtt_lists` VALUES (1,'bc430e5d-0e1e-473f-b247-0427039d3fa2',0,'Todo',1504099122,0,0,0,0);
...
LOCK TABLES `mtt_tag2task` WRITE;
...
LOCK TABLES `mtt_todolist` WRITE;
